...
Copy-paste when you open a **new agent** on a ticket. Rules in `.cursor/rules/` already load automatically — this only adds **ticket context**.
...
If there is no changelog yet, say:
