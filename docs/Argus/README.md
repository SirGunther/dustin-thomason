...
| [Phase 8 permissions and packaging evidence](<../../../Users/dktho/OneDrive/PDProjects/Argus/Architecture/PermissionsPackagingPhase8Evidence.md>) | Default-deny component authority, the OS/adapter/deferred enforcement matrix, fail-closed runtime providers, environment and credential containment, and deterministic inspectable packages with integrity hashes | Update when a permission class, an enforcement claim, or the package format changes |
