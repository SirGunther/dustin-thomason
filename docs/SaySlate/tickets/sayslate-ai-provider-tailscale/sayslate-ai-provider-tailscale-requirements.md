...
| EV-021 | Anthropic exposes `GET /v1/models`, accepts Bearer API-key authentication with the required `anthropic-version` header, and uses `output_config.format` for JSON Schema output. | [Claude API overview](https://platform.claude.com/docs/en/api/overview); [Claude Models API](https://platform.claude.com/docs/en/api/models); [Claude structured outputs](https://platform.claude.com/docs/en/build-with-claude/structured-outputs) |
