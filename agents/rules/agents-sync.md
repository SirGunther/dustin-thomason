---
description: After editing rules or skills in dustin-thomason, regenerate all downstream outputs (.cursor/rules, .claude/rules, .claude/CLAUDE.md, AGENTS.md) with sync-rules.ps1.
scope: scoped
