---
description: A dnu folder is retired work kept for posterity. Never load it as context, never cite it, never treat it as current — unless the user names it explicitly.
scope: always
codex: include
---
